...
public class AppPostulante {
    ...
    Long UsuarioID;
    ServiciosPostulante postulanteController = new ServiciosPostulante(emf);
    Postulante pos;
    Educacion educacion;
...
List<EducacionDetalle> educaciones= postulanteController.BuscarEducacionDetalle(perfil);
this.educacion=postulanteController.buscarEducacion(pos);
    if (perfil != null) {
System.out.println("==================================================");
...
System.out.println("==================================================");
System.out.println("\n" + BOLD + GREEN + ">>> EXPERIENCIA LABORAL <<<" + RESET);
System.out.println(CYAN + "--------------------------------------" + RESET);
for (ExperienciaDetalle e : experiencias) {
            System.out.printf(BOLD + BLUE + "Empresa: " + RESET + "%-25s%n", e.getEmpresa());
            System.out.printf(BOLD + MAGENTA + "Cargo:   " + RESET + "%-25s%n", e.getCargo());
            System.out.println(CYAN + "--------------------------------------" + RESET);
}

        // EDUCACIÓN
        System.out.println("\n" + BOLD + GREEN + ">>> EDUCACIÓN <<<" + RESET);
        System.out.println(CYAN + "--------------------------------------" + RESET);
        for (EducacionDetalle ed : educaciones) {
            System.out.printf(BOLD + BLUE + "Institución: " + RESET + "%-25s%n", ed.getCentroEducativo());
            System.out.printf(BOLD + MAGENTA + "Título:      " + RESET + "%-25s%n", ed.getTitulo());
            System.out.println(CYAN + "--------------------------------------" + RESET);
        }

        // Pie
        System.out.println(CYAN + "======================================" + RESET);
        System.out.println(BOLD + YELLOW + "          FIN DEL DOCUMENTO           " + RESET);
        System.out.println(CYAN + "======================================" + RESET);
    }
    else {
...
while (!salir) {
    ...
    try {
        vacantes = em.createNamedQuery("Vacante.findByStatus", Vacante.class)
    ...
    public void ModificarEducacion(){
        ...
        ServiciosOfertaEmpleo of = new ServiciosOfertaEmpleo(emf);
