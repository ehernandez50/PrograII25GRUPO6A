...
public class AppCliente {
    ...
    ServiciosCliente clienteController;
    Cliente cliente;
    Usuario id;
    ...
    public AppCliente(EntityManagerFactory emf, Usuario id) throws InterruptedException {
        ...
        this.id = id;
         ...
         clienteController= new ServiciosCliente(emf);
...
while (!salir) {
  ...
  public void CrearOfertaEmpleo() throws InterruptedException{
     ...
     int experiencia ;
      ...
      System.out.println("Descricion de Puesto");
      String descripcion = sc.nextLine();
      Integer salario;
      while (true) {          
          
      
      System.out.println("Ingrese el salrio a devengar:");
          if (!sc.hasNextLong()) {
      ...
      System.out.println("ingrese el codigo Postal del lugar de la vacante:");
      int postal;
    CodigoPostal codigoPostal = new CodigoPostal();
    ServiciosCodigoPostal c = new ServiciosCodigoPostal(emf);
    while (true) {
 ...
 FacturaDetalle facturaDetalle = servfactura.GenerarDetalleFactura(oferta, factura);
  ...
  Thread.sleep(1000);
  System.out.println("Se ha creado con exito la Oferta!!"); 
  ...
  verOf();
      ...
      try { 
          ...
          OfertaEmpleo f =  em.createNamedQuery("OfertaEmpleo.findByOfertaEmpleoId", OfertaEmpleo.class)
          .setParameter("ofertaEmpleoId", v)
          .getSingleResult();
          
          
          em.getTransaction().begin();
           em.createNamedQuery("Vacante.borrar")
          .setParameter("id", f.getVacanteId().getVacanteId())
          .executeUpdate();
          em.getTransaction().commit();
