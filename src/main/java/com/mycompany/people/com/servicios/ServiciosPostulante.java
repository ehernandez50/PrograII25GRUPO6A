...
public class ServiciosPostulante {
   ...
   public ServiciosPostulante(EntityManagerFactory emf){
   this.emf=emf;
   ...
   public void FormPostulante() throws InterruptedException, NoSuchAlgorithmException, UnknownHostException {
        EntityManager em = emf.createEntityManager();
    while (true) {
...
while (true) {
       ...
       int telAdicional;
        ...
        RegistrarPOstulante(nombre, apellido, postal, postal, telefono, telAdicional, nacionalidad, uscliente, g, codigoPostal);
                    ...
                    r.log(uscliente, "Nuevo Registro", new Date(), "se registro el usuario "+uscliente+" como Postulante");
      break;
    }
}
   ...
   public void FormEducacion(Postulante postulante){
      ...
      Educacion ed=   RegistroEducacion(nivelAcademicoId, postulante);
        ...
        System.out.println("Perfil Creado con exito. Inicie Sesion");
     ...
     while (true) {            
        ...
        Date fechaFin = leerFecha("Ingrese la fecha de fin (dd/MM/yyyy): ");
         ...
         RegistroEducacionDetalle(ed,colegio, titulo, nivel, fechaInicio, fechaFin);
            ...
            System.out.println("1. Ingresar otra Educacion\n"
                    + "2. salir");
            if (sc.hasNextInt()) {
                  int opcion = sc.nextInt();
