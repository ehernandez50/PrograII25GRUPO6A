 ...
 * @author Jovany
 */
public class ServiciosOfertaEmpleo {
    
    Scanner sc = new Scanner(System.in);
    EntityManagerFactory emf;
    
     
    public ServiciosOfertaEmpleo(EntityManagerFactory emf){
...
for (Costo costo1 : costo) {
 ...
 Costo costo7 = new Costo();
    ...
    public OfertaEmpleo CrearOferta(Cliente cliente, Vacante vacanteId, Costo costo){
...
return of;
    ...
    for (OfertaEmpleo ofertaEmpleo : of) {
        if (ofertaEmpleo.getstatus()==true) {
            
        
        System.out.println("===========================================");
        System.out.println("Oferta Empleo");
        System.out.println("COD :"+ofertaEmpleo.getOfertaEmpleoId());
            System.out.println(" Fecha: "+ofertaEmpleo.getFecha().getDay());
            System.out.println("Empresa: "+ofertaEmpleo.getClienteId().getEmpresa());
            System.out.println("Puesto: "+ofertaEmpleo.getVacanteId().getPuesto());
            System.out.println("Descripcion: "+ofertaEmpleo.getVacanteId().getDescripcion());
            System.out.println("===========================================");
        } }
        } catch (Exception e) {
    ...
    public List<OfertaEmpleo>buscarOfertas(Cliente cliente){
          List<OfertaEmpleo> of=null; 
      EntityManager em = emf.createEntityManager();
    of = em.createNamedQuery("OfertaEmpleo.buscarOfertas", OfertaEmpleo.class)
            .setParameter("cliente",cliente )
