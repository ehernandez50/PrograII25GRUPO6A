...
public class ServiciosCliente implements Serializable {
    ...
    public ServiciosCliente(EntityManagerFactory emf){
...
em.getTransaction().commit();
  ...
  public void FormCliente() throws InterruptedException, NoSuchAlgorithmException, UnknownHostException{
  ...
  while (true) {   
    ...
    System.out.println("✅ Cliente registrado correctamente.");
     register r = new register(emf);
                    r.log(uscliente, "Nuevo Registro", new Date(), "se registro el usuario "+uscliente+" como cliente");
